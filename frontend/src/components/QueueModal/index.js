...
const QueueModal = ({ open, onClose, queueId }) => {
  ...
  const handleChangePrompt = (e) => {
    const value = e.target.value !== null && e.target.value !== undefined 
      ? e.target.value 
      : "";
      ...
      {queueId
       ...
       <div style={{ display: "none" }}>
        ...
        >
          ...
          {schedulesEnabled && <Tab label="Horários de Atendimento" value={1} />}
        </Tabs>
        {tab === 0 && (
          <Paper>
            <Formik
              initialValues={{
                ...
                orderQueue: queue.orderQueue?.toString() || "",

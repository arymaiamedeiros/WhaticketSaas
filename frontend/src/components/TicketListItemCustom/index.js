...
const useStyles = makeStyles((theme) => ({
  ...
  useEffect(() => {
    ...
    const timerId = setTimeout(updateLastInteractionLabel, 30 * 1000);
  ...
  }, [ticket]); // Dependência no ticket para atualizar quando o ticket mudar
...
<span className={classes.secondaryContentSecond}>
  {ticket.status === "pending" && (
    <>
      <ButtonWithSpinner
        ...
        aria-label={i18n.t("ticketsList.buttons.accept")}
      >
      ...
      <ButtonWithSpinner
        ...
        aria-label={i18n.t("ticketsList.buttons.closed")}
      >
  ...
  {ticket.status !== "closed" && ticket.status !== "pending" && ticket.status !== "attending" && (
    <>
      <ButtonWithSpinner
        ...
        aria-label={i18n.t("ticketsList.buttons.transfer")}
      >
  ...
  {ticket.status === "closed" && (
    <ButtonWithSpinner
      ...
      aria-label={i18n.t("ticketsList.buttons.reopen")}
    >

          ...
          <Paper elevation={0} square className={classes.tabsHeader}>
            ...
            >
              <Tab
                ...
                aria-label={i18n.t('tickets.tabs.open') || "Chat em aberto"}
              />
              {setGroupBox && (
                <Tab
                  value={'group'}
                  icon={<GroupIcon />}
                  classes={{ root: classes.tab }}
                  aria-label={i18n.t('tickets.tabs.group') || "Grupos"}
                />
              )}
              <Tab
                value={'closed'}
                icon={<DoneAllIcon />}
                classes={{ root: classes.tab }}
                aria-label={i18n.t('tickets.tabs.closed') || "Fechados"}
              />
              <Tab
                value={'search'}
                icon={<SearchIcon />}
                classes={{ root: classes.tab }}
                aria-label={i18n.t('tickets.tabs.search') || "Pesquisar"}
              />
            </Tabs>
          </Paper>
        </>
          ...
          <>
            {
                ...
                >
                  <IconButton
                    ...
                    aria-label={i18n.t("tickets.buttons.newTicket") || "Novo ticket"}
                  >
            ...
            {user.profile === "admin" && (
              ...
              >
                <IconButton
                  ...
                  aria-label={i18n.t("tickets.inbox.closedAll") || "Fechar todos os tickets"}
                >
      ...
      <TabPanel value={tab} name='open' className={classes.ticketsWrapper}>
        ...
        >
          <Tab
            ...
            value={'open'}
            aria-label={i18n.t('ticketsList.assignedHeader') || "Atribuídos"}
          />
          <Tab
            label={
              <Badge
            ...
            value={'pending'}
            aria-label={i18n.t('ticketsList.pendingHeader') || "Pendentes"}
          />
        </Tabs>
